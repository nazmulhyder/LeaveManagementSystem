...
if(!empty($_POST)) {
    ...
    $sql="INSERT INTO `appli`(`first_name`, `last_name`, `position`, `supervisor`, `subject`, `discription`,sdate,edate) 
	VALUES ('$first_name','$last_name','$position','$supervisor','$subject','$discription','$sdate','$edate')";
...
<div>
  <form method="post">
    ...
    <option>1st Line Manager</option>
...
<p id="demo"></p>
	...
	<select id="mySelect1" name="supervisor">
    <option>1st Line Manager</option>
    <option>Middle Manager</option>
    <option>Top Manager</option>
  </select>
